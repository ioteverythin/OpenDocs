...
class ChangelogGenerator(BaseGenerator):
    """DocumentModel → Release Notes / Changelog Markdown."""
    ...
    def _build_changelog(self, doc: DocumentModel) -> str:
        ...
        lines.append("---")
        lines.append(f"*Generated by [opendocs](https://pypi.org/project/opendocs/) on {today}*")
        lines.append("")
    ...
    def _walk_section(
        ...
        if section.blocks and not any(isinstance(b, (ListBlock, ParagraphBlock)) for b in section.blocks):
